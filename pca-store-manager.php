...
define( 'PCA_STORE_PATH', plugin_dir_path( __FILE__ ) );
define( 'PCA_STORE_URL', plugin_dir_url( __FILE__ ) );

require_once PCA_STORE_PATH . 'includes/class-activator.php';
require_once PCA_STORE_PATH . 'includes/class-permissions.php';
require_once PCA_STORE_PATH . 'admin/class-admin-menu.php';
